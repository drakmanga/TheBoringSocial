...
try {
    ...
    foreach ($postUser as $post) {
        ...
        foreach($commentsPost as $commentPost) {
            ...
            $post->getId(), $userData->getImagePath(), $post->getId(), $userData->getName() . $userData->getSurname(), $commentPost->getDate(), $commentPost->getComment());
        }
        ...
        <li>',  
                ...
                count($likeCount), $userProfile->getUsername(),$post->getId(), $like, $post->getId(), $post->getId(), $user->getImagePath(), 
                $userProfile->getUsername(), $post->getId(), $comment);
